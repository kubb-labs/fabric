...
The stc module is part of `@kubb/fabric-core`:
...
```typescript
import { createContext, useContext } from '@kubb/fabric-core/stc'
...
```typescript
import { createSignal } from '@kubb/fabric-core/stc'
...
```typescript
import { createReference, getReference } from '@kubb/fabric-core/stc'
