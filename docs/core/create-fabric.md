...
```ts [use-plugin.ts]
import { fsPlugin, loggerPlugin } from '@kubb/fabric-core'
import { typescriptParser } from '@kubb/fabric-core'
...
```ts [write-files.ts]
import { fsPlugin } from '@kubb/fabric-core'
...
```ts [write-entry.ts]
import { barrelPlugin } from '@kubb/fabric-core'
...
import { createFabric } from '@kubb/fabric-core'
import { fsPlugin } from '@kubb/fabric-core'
import { typescriptParser, tsxParser } from '@kubb/fabric-core'
